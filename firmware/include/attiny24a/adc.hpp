...
// 2
constexpr auto adps_2 = avrcpp::register_field<adcsra_register, 0, 3>{ 0 };

// 4
constexpr auto adps_4 = avrcpp::register_field<adcsra_register, 0, 3>{ 0 };

// 8
constexpr auto adps_8 = avrcpp::register_field<adcsra_register, 0, 3>{ 0 };

// 16
constexpr auto adps_16 = avrcpp::register_field<adcsra_register, 0, 3>{ 0 };

// 32
constexpr auto adps_32 = avrcpp::register_field<adcsra_register, 0, 3>{ 0 };

// 64
constexpr auto adps_64 = avrcpp::register_field<adcsra_register, 0, 3>{ 0 };

// 128
constexpr auto adps_128 = avrcpp::register_field<adcsra_register, 0, 3>{ 0 };
...
// Analog Comparator
constexpr auto adts_analog_comparator = avrcpp::register_field<adcsrb_register, 0, 3>{ 0 };

// External Interrupt Request 0
constexpr auto adts_external_interrupt_request_0 = avrcpp::register_field<adcsrb_register, 0, 3>{ 0 };

// Timer/Counter0 Compare Match A
constexpr auto adts_timer_counter0_compare_match_a = avrcpp::register_field<adcsrb_register, 0, 3>{ 0 };

// Timer/Counter0 Overflow
constexpr auto adts_timer_counter0_overflow = avrcpp::register_field<adcsrb_register, 0, 3>{ 0 };

// Timer/Counter1 Compare Match B
constexpr auto adts_timer_counter1_compare_match_b = avrcpp::register_field<adcsrb_register, 0, 3>{ 0 };

// Timer/Counter1 Overflow
constexpr auto adts_timer_counter1_overflow = avrcpp::register_field<adcsrb_register, 0, 3>{ 0 };

// Timer/Counter1 Capture Event
constexpr auto adts_timer_counter1_capture_event = avrcpp::register_field<adcsrb_register, 0, 3>{ 0 };
...
constexpr auto refs_internal_1_1v_voltage_reference = avrcpp::register_field<admux_register, 6, 2>{ 0 };

// Reserved
constexpr auto refs_reserved = avrcpp::register_field<admux_register, 6, 2>{ 0 };
